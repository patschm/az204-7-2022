...
namespace EvtHubConsumer
{
    class Program
    {
        private const string conStr = "Endpoint=sb://ps-hupholland.servicebus.windows.net/;SharedAccessKeyName=lezert;SharedAccessKey=WN/XGdeDRiKFAmhAjs9O6sJCurFKjQmgrsK/+/w3ovs=;EntityPath=blaat";
        private const string hubName = "blaat";

        private const string checkpointStorage = "DefaultEndpointsProtocol=https;AccountName=psstoor;AccountKey=JoZ8fIrOonCWG4ja5Yigzs0tnNNn1cXydeiBKJtLt6korQMP3+ZgsRXbmm8iIt77w5VOLGsIZovz+ASt/BVBHA==;EndpointSuffix=core.windows.net";
