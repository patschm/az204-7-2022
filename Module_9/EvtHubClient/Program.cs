...
namespace EvtHubClient
{
    class Program
    {
        private static string conStr = "Endpoint=sb://ps-hupholland.servicebus.windows.net/;SharedAccessKeyName=schrijvert;SharedAccessKey=jir1mCcWSKvyQGjGgQBEfkRkk90MrqM1OKZG+lQVH8I=;EntityPath=blaat";
        private static string hubName = "blaat";
